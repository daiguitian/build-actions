...
export Op_name="R2S"                # 修改主机名称为OpenWrt-123(填0为不作修改)
...
export Customized_Information="rockchip-armv8-friendlyarm_nanopi-r2s"  # 个性签名,你想写啥就写啥，(填0为不作修改)
...
version.buildinfo
profiles.json
openwrt-r2s-generic-kernel.bin
openwrt-r2s-generic.manifest
openwrt-r2s-generic-squashfs-rootfs.img.gz
EOF
